...
const PixelTrailDemo: React.FC = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-background text-foreground min-h-[700px] flex flex-col">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-32 pb-20 md:pt-40 md:pb-32 flex-1 flex flex-col justify-center pointer-events-none">
        {/* Eyebrow */}
        <motion.div
        ...
        {/* Headline */}
        <motion.h1
          className="max-w-5xl text-[clamp(2.5rem,8vw,7rem)] font-black leading-[0.88] tracking-tighter"
      ...
      {/* Trust row */}
      <motion.div
        className="relative z-10 mt-auto border-t border-border/30 px-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
